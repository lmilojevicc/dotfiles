...
- Does not access your saved passwords/credentials (Chrome sandboxing)
- Does not exfiltrate data to remote servers
- Does not inject ads, malware, or miners
- Does not track browsing or send analytics
- Does not modify system files outside its state directory (`~/.pinchtab`)
